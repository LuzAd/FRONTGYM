...
<div class="py-16">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div class="hidden lg:block lg:w-1/2 bg-cover"
            style="background-image:url('https://hips.hearstapps.com/hmg-prod/images/personal-weight-training-in-the-gym-royalty-free-image-1568020980.jpg?crop=0.65809xw:1xh;center,top&resize=2048:*')">
        </div>
        <div class="w-full p-8 lg:w-1/2">
            <h2 class="text-2xl font-semibold text-gray-700 text-center">Bull´s Gym</h2>
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="#" class="text-xs text-center text-gray-500 uppercase">o entrar con correo</a>
                <span class="border-b w-1/5 lg:w-1/4"></span>
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                <div class="flex justify-between">
                    ...
                    <a href="#" class="text-xs text-gray-500">Olvidaste la contraseña?</a>
                </div>
